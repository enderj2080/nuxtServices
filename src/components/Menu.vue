<template>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-200">
            <NuxtLink to="/" class="text-gray-800 dark:text-gray-200 border-b-2 border-blue-500 mx-1.5 sm:mx-6">home
            </NuxtLink>

            <NuxtLink to="/admin"
                class="dark:text-gray-200 border-b-2 border-transparent hover:text-gray-500 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">
                Acministracion</NuxtLink>
            ...
            <a>
                <button @click="darkToggle()">{{ isDark ? "dark" : "ling" }}</button></a>
        </div>
    </nav>
</template>
